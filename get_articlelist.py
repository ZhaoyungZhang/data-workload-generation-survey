...
LastEditTime: 2024-10-20 16:41:15
FilePath: /findPapers/get_articlelist.py
'''
import requests
import json
import urllib3
...
def airtcle_list(searchword):
    ...
    try:
        ...
        print(f'搜索关键词:{searchword}')
        print(f'共检索到{totalrecords}篇文章')
    except KeyError:
        print(f"未找到关于 {searchword} 的文章")
        return []
